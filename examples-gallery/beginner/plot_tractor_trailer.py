...
A tractor has two trailers attached to it, and the goal is to park it in a
...
- :math:`q_{11}, q_{21}, q_{31}`: The steering angles of the axles w.r.t. the
  respective vehicles.
- :math:`x, y`: The position of the mass center of the tractor in the
  inertial frame.
- :math:`u_{10}, u_{20}, u_{30}`: The angular velocities of the tractor and
  trailers.
- :math:`u_{11}, u_{21}, u_{31}`: The angular velocities of the steering axles.
...
- :math:`m_1, m_2, m_3`: The masses of the tractor and trailers.
- :math:`m_w`: The mass of the wheels.
- :math:`l_1, l_2, l_3`: The lengths of the tractor and trailers.
...
- :math:`x_{3b}, y_{3b}`: The position of the back end of the second trailer
...
# %%
# Parameters.
m1, m2, m3, mw, l1, l2, l3, ld, lax, g = sm.symbols(
    'm1 m2 m3 mw l1 l2 l3 ld lax g')
...
print(f"the eoms contain {sm.count_ops(eom):,} operations and shape "
      f"{eom.shape}")
...
fname = f"tractor_trailer_{num_nodes}_nodes_solution.csv"
...
for point in (P1f, P1b, P2f, P2b, P3f, P3b,
              P1fl, P1fr, P1bl, P1br,
              P2fl, P2fr, P2bl, P2br,
              P3fl, P3fr, P3bl, P3br, arrow_head):
