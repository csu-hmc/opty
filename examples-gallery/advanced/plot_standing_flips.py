...
bounds.update({k: (-np.deg2rad(600.0), np.deg2rad(600.0))
...
instance_constraints = (
    ...
    qay.func(duration) - (-fyd + lb + lc - 0.1),
    qa.func(duration) + np.deg2rad(360.0),
...
fname = f'human_standing_flip_{num_nodes}_nodes_solution.csv'
