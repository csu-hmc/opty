...
- Show an objective function which is a weighted average of the time and of the
  energy needed.
- Show how to use an additional state variable to optimize the shape of the
  boat.
...
print('sequence of unknown_parameters:', prob.collocator.unknown_parameters)
# %%
...
fname = f'mississippi_steamboat_shape_{num_nodes}_nodes_solution.csv'
aaa = 10
