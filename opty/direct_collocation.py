...
from opty.utils import (ufuncify_matrix, parse_free, _optional_plt_dep,
...
initial_guess = np.load('test_constraints.npy')
# %%
# Solve the problem.
...
np.save('test_constraints', solution)
